...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex md:flex-col h-10 items-center rounded-md p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
